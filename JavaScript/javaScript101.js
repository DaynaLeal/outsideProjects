...
function third(inputSequence){
    return inputSequence[2];
}
...
function forth(inputSequence){
    return inputSequence[3];
}
...
function last(inputSequence){
    return inputSequence[inputSequence.length - 1];
}
...
function secondToLast(inputSequence){
...
function thirdToLast(inputSequence){
    return inputSequence[inputSequence.length - 3];
}
...
function firstAndSecond(inputSequence){
    var newBucket = [];

    newBucket.push(first(inputSequence), second(inputSequence));
    return newBucket;
}
...
function firstAndLast(inputSequence){
    var newBucket = [];

    newBucket.push(first(inputSequence), last(inputSequence));
    return newBucket;
}
...
function firstToLast(inputSequence){
    var first = inputSequence[0];
    console.log(first);
    inputSequence.shift();
    console.log(inputSequence);

    inputSequence.push(first);
...
function mean(numberArray){
    ...
    for(var i = 0; i < numberArray.length; i++){
        averageValue += numberArray[i];
    }
    return averageValue / numberArray.length;
}
...
function maxMinusMin(numberArray){
    return (Math.max(...numberArray)) - (Math.min(...numberArray));
    //spread operator includes the "...";
}
...
function productOfAll(numbersArray){
    var product = 1;
...
function getHighestNumber(numbersArray){
...
function onlyOddNumbers(numbersArray){
    var bucketArray = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] % 2 !== 0){
            bucketArray.push(numbersArray[i]);
        }
    }
    return bucketArray;
};
...
function onlyEvenNumbers(numbersArray){
    var bucketArray = [];
...
function onlyPositiveNumbers(numbersArray){
    var positiveBucket = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] > 0){
            positiveBucket.push(numbersArray[i]);
        }
    }
    return positiveBucket;
}
...
function onlyNegativeNumbers(numbersArray){
    var negativeBucket = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] < 0){
            negativeBucket.push(numbersArray[i]);
        }
    }
    return negativeBucket;
}
...
function hasEvens(numbersArray){
    return numbersArray.some(function(element){
        return element % 2 === 0;
    });
}
...
function hasOdds(numbersArray){
    return numbersArray.some(function(numbersElement){
...
function countOdds(numbersArray){
    var oddsBucket = 0;
...
function countNegatives(numbersArray){
    var negativesTotal = 0;
...
function countPositives(numbersArray){
    var positivesTotal = 0;
...
function onlyPositiveEvens(numbersArray){
    var posEvensArray = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] > 0 && numbersArray[i] % 2 === 0){
            posEvensArray.push(numbersArray[i]);
        }
    }
    return posEvensArray;
}
...
function onlyPositiveOdds(numbersArray){
    var posOddsArray = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] > 0 && numbersArray[i] % 2 !== 0){
            posOddsArray.push(numbersArray[i]);
        }
    }
    return posOddsArray;
}
...
function onlyNegativeEvens(numbersArray){
    var negEvensArray = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] < 0 && numbersArray[i] % 2 === 0){
            negEvensArray.push(numbersArray[i]);
        }
    }
    return negEvensArray;
}
...
function onlyNegativeOdds(numbersArray){
    var negOddsArray = [];

    for(var i = 0; i < numbersArray.length; i++){
        if(numbersArray[i] < 0 && numbersArray[i] % 2 !== 0){
            negOddsArray.push(numbersArray[i]);
        }
    }
    return negOddsArray;
}
...
function getUniqueValues(inputArray){
    var uniqueArray = [];
    return inputArray.filter(distinct);
}
...
function elementsTimesTwo(inputArray){
    var numberBucket = [];

    inputArray.forEach(function(numberElement){
        numberElement = (numberElement * 2);
        numberBucket.push(numberElement);
    });
...
function flatten(arrayArray){
    var merged = [].concat.apply([], arrayArray);
    return merged;
}
...
function addOneToArray(numberArray){
    var plusOne = [];
...
//create an object called comparisonObject set to zero
//if object is greater than comparisonObject = comparisonObject
//if object is less than comparisonObject continue loop
...
function highestPriceBook(bookArray){
    ...
    for(var i = 0; i < bookArray.length; i++){
        if(bookArray[i].price > comparisonObject.price){
            }
}
...
// Hint: How do you access a key's value on a object? The tax rate is one key of the entire shoppingCart object.
    ...
    function getTaxRate(inputObject){
        return inputObject.tax;
    }
...
// We're not yet using the quantity of each item, but rather focusing on determining how many different types of items are in the cart.
    ...
    function numberOfItemTypes(inputCartObject){
        var bucketArray = [];
        ...
        for(var i = 0; i < inputArray.length; i++){
            ...
            bucketArray.push(inputArray[i].title);
            console.log(bucketArray);
        }

        var unique = bucketArray.filter( onlyUnique );
        console.log(unique);
...
// This should return the sum of all of the quantities from each item type
    ...
    function totalNumberOfItems(inputCartObject){
        var itemCount = 0;
        var inputArray = inputCartObject.items;
        console.log(inputArray);

        for(var i = 0; i < inputArray.length; i++){
            itemCount += inputArray[i].quantity;
        }
